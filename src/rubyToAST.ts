...
const execTextlintRuby = async (client: Client, text: string, filePath: string | undefined): Promise<any> => {
  let path: string
...
export const rubyToAST = async (client: Client, text: string, filePath: string | undefined): Promise<AnyTxtNode> => {
